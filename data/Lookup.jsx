...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Vibe',
  SIGNIN_SUBHEADING: 'To use Vibe you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Vibe, you agree to the collection of usage data for analytics.',
